  ...
  messages: {
    fr: {
      ...
      msppData: {
        ...
        NICUDischarged: "Du nombre total de sorties : USIN sorties",
        diedInNICUBefore48: "Décédé à l'USIN avant 48h",
        diedInPaedBefore48: "Décédé au PAED avant 48h",
        diedInNICUAfter48: "Décédé à l'USIN après 48h",
        diedInPaedAfter48: "Décédé dans le PAED après 48h",
        reasonSelfDischarge: "Raison de l'autodécharge",
        financeCannotAfford: "Finances : partez car vous ne pouvez pas vous permettre des soins",
        financeAvoidPay: "Finances : à gauche pour éviter de payer",
        reasonCultural: "Religieux / Culturel",
        reasonPersonal: "Personnel / Famille",
        otherReason: "Autre",
        wherePatientsComeFrom: "D'où viennent les patients ?",
        fromQuarterMorin: "Quartier Morin",
        fromCapHaitian: "Cap Haïtien",
        fromDepartmentNord: "Département du Nord",
        fromOther: "Autres départements: ",
        ageOfInfant: "Âge du nourrisson admis",
        admissionsExtremelyPreterm: "Extrêmement prématuré (moins de 28 semaines)",
        admissionsVeryPreterm: "Très prématuré (28 à 32 semaines)",
        admissionsModerateToLatePreterm: "Prématuré modéré à tardif (32 à 37 semaines)",
        admissionsFullTerm: "Terme complet (37 semaines et plus)",
        admissionsOlderThanNeonate: "Plus âgé que le nouveau-né (> 4 semaines)",
        admissionsAge4WeeksTo5: "Âge 4 semaines - 5 ans",
        admissionsAge6To11: "6-11 ans",
        admissionsAge12To18: "12-18 ans",
        gender: "Genre",
        admissionsMale: "Mâle",
        admissionsFemale: "Femelle",
        mainCond: "État principal",
        admissionsRespiratoryArrest: "Arrêt respiratoire",
        admissionsTraumaticInjury: "Blessure traumatique",
        admissionsSepticShock: "Choc septique",
        admissionsHypovolemicShock: "Choc hypovolémique",
        admissionsSeizures: "Saisies/Convulsions",
        admissionsPoisoning: "Empoisonnement",
        admissionsAlteredMentalStatus: "État mental altéré",
        admissionsGastroenteritis: "Gastro-entérite",
        admissionsHemorrhage: "Hémorragie",
        admissionsHypothermia: "Hypothermie",
        admissionsCardiacCongenitalAnomaly: "Anomalie cardiaque congénitale",
        admissionsOtherCongenitalAnomaly: "Autre anomalie congénitale",
        admissionsMalnutrition: "Malnutrition",
        admissionsMeningitis: "Méningite",
        admissionsCommunityAcquiredPneumonia: "Pneumonie communautaire",
        admissionsAspirationPneumonia: "Pneumonie par aspiration",
        admissionsModeratePrematurity: "Prématurité modérée (32-36 semaines de gestation)",
        admissionsSeverePrematurity: "Prématurité sévère (moins de 32 semaines)",
        admissionsOtherMedical: "Autre médical: ",
        numberOfOutpatients: "Nombre de patients externes",
        numberOfOutpatientsExtremelyPreterm: "Extrêmement prématuré (moins de 28 semaines)",
        numberOfOutpatientsVeryPreterm: "Très prématuré (28 à 32 semaines)",
        numberOfOutpatientsModerateToLatePreterm: "Prématuré modéré à tardif (32 à 37 semaines)",
        numberOfOutpatientsFullTerm: "Terme complet (37 semaines et plus)",
        numberOfOutpatientsOlderThanNeonate: "Plus âgé que le nouveau-né (> 4 semaines)",
        numberOfOutpatientsAge4WeeksTo5: "Âge 4 semaines - 5 ans",
        numberOfOutpatientsAge6To11: "6-11 ans",
        numberOfOutpatientsAge12To18: "12-18 ans",
        numberOfOutpatientsMale: "Mâle",
        numberOfOutpatientsFemale: "Femelle",
        numberOfOutpatientsRespiratoryArrest: "Arrêt respiratoire",
        numberOfOutpatientsTraumaticInjury: "Blessure traumatique",
        numberOfOutpatientsSepticShock: "Choc septique",
        numberOfOutpatientsHypovolemicShock: "Choc hypovolémique",
        numberOfOutpatientsSeizures: "Saisies/Convulsions",
        numberOfOutpatientsPoisoning: "Empoisonnement",
        numberOfOutpatientsAlteredMentalStatus: "État mental altéré",
        numberOfOutpatientsGastroenteritis: "Gastro-entérite",
        numberOfOutpatientsHemorrhage: "Hémorragie",
        numberOfOutpatientsHypothermia: "Hypothermie",
        numberOfOutpatientsCardiacCongenitalAnomaly: "Anomalie cardiaque congénitale",
        numberOfOutpatientsOtherCongenitalAnomaly: "Autre anomalie congénitale",
        numberOfOutpatientsMalnutrition: "Malnutrition",
        numberOfOutpatientsMeningitis: "Méningite",
        numberOfOutpatientsCommunityAcquiredPneumonia: "Pneumonie communautaire",
        numberOfOutpatientsAspirationPneumonia: "Pneumonie par aspiration",
        numberOfOutpatientsModeratePrematurity: "Prématurité modérée (32-36 semaines de gestation)",
        numberOfOutpatientsSeverePrematurity: "Prématurité sévère (moins de 32 semaines)",
        numberOfOutpatientsOtherMedical: "Autre médical: ",
    ...
    en: {
      ...
      msppData: {
        ...
        NICUDischarged: "Of total discharged number: NICU discharged",
        diedInNICUBefore48: "Died in the NICU before 48h",
        diedInPaedBefore48: "Died in the PAED before 48h",
        diedInNICUAfter48: "Died in the NICU after 48h",
        diedInPaedAfter48: "Died in the PAED after 48h",
        reasonSelfDischarge: "Reason for self-discharge",
        financeCannotAfford: "Finance: Leave as cannot afford care",
        financeAvoidPay: "Finance: Left to avoid paying",
        reasonCultural: "Religious / Cultural",
        reasonPersonal: "Personal / Family",
        otherReason: "Other",
        wherePatientsComeFrom: "Where do patients come from?",
        fromQuarterMorin: "Quarter Morin",
        fromCapHaitian: "Cap Haitian",
        fromDepartmentNord: "Department Nord",
        fromOther: "Other Departments: ",
        ageOfInfant: "Age of infant admitted",
        admissionsExtremelyPreterm: "Extremely preterm (less than 28 weeks)",
        admissionsVeryPreterm: "Very preterm (28 to 32 weeks)",
        admissionsModerateToLatePreterm: "Moderate to late preterm (32 to 37 weeks)",
        admissionsFullTerm: "Full term (37 weeks plus)",
        admissionsOlderThanNeonate: "Older than neonate (>4 weeks old)",
        admissionsAge4WeeksTo5: "Age 4 weeks - 5 years",
        admissionsAge6To11: "Age 6-11 years",
        admissionsAge12To18: "Age 12-18 years",
        gender: "Gender",
        admissionsMale: "Male",
        admissionsFemale: "Female",
        mainCond: "Main Condition",
        admissionsRespiratoryArrest: "Respiratory arrest",
        admissionsTraumaticInjury: "Traumatic injury",
        admissionsSepticShock: "Septic shock",
        admissionsHypovolemicShock: "Hypovolemic shock",
        admissionsSeizures: "Seizures/Convulsions",
        admissionsPoisoning: "Poisoning",
        admissionsAlteredMentalStatus: "Altered mental status",
        admissionsGastroenteritis: "Gastroenteritis",
        admissionsHemorrhage: "Hemorrhage",
        admissionsHypothermia: "Hypothermia",
        admissionsCardiacCongenitalAnomaly: "Cardiac congenital anomaly",
        admissionsOtherCongenitalAnomaly: "Other congenital anomaly",
        admissionsMalnutrition: "Malnutrition",
        admissionsMeningitis: "Meningitis",
        admissionsCommunityAcquiredPneumonia: "Community acquired pneumonia",
        admissionsAspirationPneumonia: "Aspiration pneumonia",
        admissionsModeratePrematurity: "Moderate prematurity (32-36 weeks gestation)",
        admissionsSeverePrematurity: "Severe prematurity (less than 32 weeks)",
        admissionsOtherMedical: "Other medical: ",
        numberOfOutpatients: "Number of outpatients",
        numberOfOutpatientsExtremelyPreterm: "Extremely preterm (less than 28 weeks)",
        numberOfOutpatientsVeryPreterm: "Very preterm (28 to 32 weeks)",
        numberOfOutpatientsModerateToLatePreterm: "Moderate to late preterm (32 to 37 weeks)",
        numberOfOutpatientsFullTerm: "Full term (37 weeks plus)",
        numberOfOutpatientsOlderThanNeonate: "Older than neonate (>4 weeks old)",
        numberOfOutpatientsAge4WeeksTo5: "Age 4 weeks - 5 years",
        numberOfOutpatientsAge6To11: "Age 6-11 years",
        numberOfOutpatientsAge12To18: "Age 12-18 years",
        numberOfOutpatientsMale: "Male",
        numberOfOutpatientsFemale: "Female",
        numberOfOutpatientsRespiratoryArrest: "Respiratory arrest",
        numberOfOutpatientsTraumaticInjury: "Traumatic injury",
        numberOfOutpatientsSepticShock: "Septic shock",
        numberOfOutpatientsHypovolemicShock: "Hypovolemic shock",
        numberOfOutpatientsSeizures: "Seizures/Convulsions",
        numberOfOutpatientsPoisoning: "Poisoning",
        numberOfOutpatientsAlteredMentalStatus: "Altered mental status",
        numberOfOutpatientsGastroenteritis: "Gastroenteritis",
        numberOfOutpatientsHemorrhage: "Hemorrhage",
        numberOfOutpatientsHypothermia: "Hypothermia",
        numberOfOutpatientsCardiacCongenitalAnomaly: "Cardiac congenital anomaly",
        numberOfOutpatientsOtherCongenitalAnomaly: "Other congenital anomaly",
        numberOfOutpatientsMalnutrition: "Malnutrition",
        numberOfOutpatientsMeningitis: "Meningitis",
        numberOfOutpatientsCommunityAcquiredPneumonia: "Community acquired pneumonia",
        numberOfOutpatientsAspirationPneumonia: "Aspiration pneumonia",
        numberOfOutpatientsModeratePrematurity: "Moderate prematurity (32-36 weeks gestation)",
        numberOfOutpatientsSeverePrematurity: "Severe prematurity (less than 32 weeks)",
        numberOfOutpatientsOtherMedical: "Other medical: ",
