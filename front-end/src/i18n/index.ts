...
const i18n = createI18n({
  ...
  messages: {
    fr: {
      ...
      sideBar: {
        HHA: "ESPOIR SANTÉ ACTION",
        leaderBoard: "Classement",
        addAward: "Ajouter une prix",
      ...
      dataDisplay: {
        ...
        setEmployeeOTM: "Définir l'employé du mois",
        ...
        caseStudyType: "Type d'étude de cas",
      ...
      msppData: {
        ...
        breastfeeding_WomenVitA: "Femmes allaitantes recevant de la vitamine A",
        breastfeeding_WomenMUAC: "Femmes allaitantes avec PB <210mm",
        breastfeeding_WomenMalnutrition: "Femmes allaitantes avec MAM/MAS prises en charge",
        ...
        length2_3y: "2-3 ans",
        length3_y: "3+ ans",
        mainCondition: "État principal", 
        mainConditionTetraplegia: "SCI - tétraplégie",
        mainConditionComplete: "Compléter",
        mainConditionIncomplete: "Incomplète",
        mainConditionC1: "Niveau de blessure : C1",
        mainConditionC2: "Niveau de blessure : C2",
        mainConditionC3: "Niveau de blessure : C3",
        mainConditionC4: "Niveau de blessure : C4",
        mainConditionC5: "Niveau de blessure : C5",
        mainConditionC6: "Niveau de blessure : C6",
        mainConditionC7: "Niveau de blessure : C7",
        mainConditionC8: "Niveau de blessure : C8",
        mainConditionT1: "Niveau de blessure : T1",
        mainConditionParaplegia: "SCI - paraplégie",
        mainConditionComplete2: "Compléter",
        mainConditionIncomplete2: "Incomplète",
        mainConditionT2: "Niveau de blessure : T2",
        mainConditionT3: "Niveau de blessure : T3",
        mainConditionT4: "Niveau de blessure : T4",
        mainConditionT5: "Niveau de blessure : T5",
        mainConditionT6: "Niveau de blessure : T6",
        mainConditionT7: "Niveau de blessure : T7",
        mainConditionT8: "Niveau de blessure : T8",
        mainConditionT9: "Niveau de blessure : T9",
        mainConditionT10: "Niveau de blessure : T10",
        mainConditionT11: "Niveau de blessure : T11",
        mainConditionT12: "Niveau de blessure : T12",
        mainConditionL1: "Niveau de blessure : L1",
        mainConditionL2: "Niveau de blessure : L2",
        mainConditionL3: "Niveau de blessure : L3",
        mainConditionL4: "Niveau de blessure : L4",
        mainConditionL5: "Niveau de blessure : L5",
        mainConditionS1: "Niveau de blessure : S1",
        mainConditionS2: "Niveau de blessure : S2",
        mainConditionS3: "Niveau de blessure : S3",
        mainConditionS4: "Niveau de blessure : S4",
        mainConditionS5: "Niveau de blessure : S5",
        causeOfSCI: "Cause de la LME", 
        SCITransportAccident: "Accident de transport",
        SCIFall: "Tomber",
        SCIAssault: "Agression",
        SCISports: "Des sports",
        SCINonTraumaticSpinalCordDysfunction: "Dysfonctionnement non traumatique de la moelle épinière",
        SCIMedical: "Complication médicale/chirurgicale",
        SCIOtherTraumaticReason: "Autre raison traumatisante",
        ageRehab: "Âge",
        SCIAge0_5: "Âge 0-5",
        SCIAge6_11: "Âge 6-11",
        SCIAge12_18: "Âge 12-18", 
        SCIAge18_30: "Âge 18-30",
        SCIAge31_50: "Âge 31-50",
        SCIAge51_70: "Âge 51-70",
        SCIAge70: "Âge 70+",
        genderRehab: "Genre",
        SCIMale: "Mâle",
        SCIFemale: "Femelle",
        mainConditionCont: "État principal - Suite",
        mainConditionStroke: "AVC/AVC",
        mainConditionFracturedHip: "Hanche fracturée",
        mainConditionFracturedLongBones: "Os longs fracturés",
        mainConditionNeurodegenerativeDisease: "Maladie neurodégénérative",
        mainConditionHeadInjury: "Blessure à la tête",
        mainConditionWoundCare: "Les soins des plaies",
        mainConditionOtherMedical: "Autre médical",
        mainConditionOtherTrauma: "Autre traumatisme",
        timeFromInjury: "Délai entre la blessure et l'admission en réadaptation",
        timeLessThan1m: "Moins de 1 mois",
        time1_2m: "1-2 mois",
        time3m: "3 mois",
        time6m: "6 mois",
        time1y: "1 an",
        time2y: "2 ans",
        timeMoreThan3y: "3+ ans",
        numberOfOutpatientsRehab: "Nombre de patients externes",
        returningOutpatients: "Retour des patients ambulatoires",
        newOutpatient: "Nouvelles évaluations initiales ambulatoires",
        mainConditionOfNewPatients: "État principal des nouveaux patients",
        newSCIParaplegia: "SCI - paraplégie",
        newSCITetraplegia: "SCI - tétraplégie",
        newStroke: "AVC/AVC",
        newFracturedHip: "Hanche fracturée",
        newFracturedLongBones: "Os longs fracturés",
        newNeurodegenerativeDisease: "Maladie neurodégénérative",
        newHeadInjury: "Blessure à la tête",
        newWoundCare: "Les soins des plaies",
        newCerebralPalsy: "Infirmité motrice cérébrale",
        newDownSyndromel: "Syndrome de Down",
        newOther: "Autre",
        ageOfNewpatients: "Âge des nouveaux patients",
        newAge0_5: "Âge 0-5",
        newAge6_11: "Âge 6-11",
        newAge12_18: "Âge 12-18",
        newAge18_30: "Âge 18-30",
        newAge31_50: "Âge 31-50",
        newAge51_70: "Âge 51-70",
        newAge70: "Âge 70+",
      ...
      caseStudyForm: {
        ...
        addPhoto: "Ajouter une photo: ",
        submit: "Soumettre",
        patient_story: "Témoignage de patients",
        staff_recognition: "Reconnaissance du personnel",
        training_session: "Session de formation",
        equipment_received: "Équipement reçu",
      },
      patient: {
        patient: "Patient",
        age: "Âge",
        causeOfDeath: "Cause de décès",
        removePatient: "Supprimer le patient X",
        ...
        numDaysInRehab: "Nombre de jours dans l'unité de réadaptation de l'admission à la sortie: ",
        dischargeReason: "Raison de sortie",
        allGoalsMet: "Tous les objectifs atteints",
        goalsPartiallyMet: "Objectifs partiellement atteints, suffisants pour le congé",
        goalsNotMet: "Objectifs non atteints, congédié pour une autre raison",
        dischargeOutcomeASC: "Résultat de sortie (AVQ/soins personnels)",
        independent: "Indépendant",
        modIndependent: "Indépendant modifié",
        supervision: "Surveillance",
        minAssistance: "Assistance minimale",
        modAssistance: "Aide modérée",
        maxAssistance: "Assistance maximale",
        dependent: "Dépendant",
        dischargeOutcomeTM: "Résultat de sortie (transferts et mobilité)",
        mobilityAid: "Aide à la mobilité/dispositif d'assistance fourni?",
        wheelchair: "Fauteuil roulant",
        walker: "Marcheur",
        cane: "Canne",
        crutches: "Béquilles",
        dischargeLocation: "Lieu de décharge",
        returnHomeAlone: "Retour à la maison, seul",
        returnHomeFamily: "Retour à la maison, avec famille/aidant(s)",
        admittedToHospital: "Admis à l'hôpital",
        dischargeEmploymentStatus: "Statut d'emploi de sortie",
        employed: "Employé",
        unemployedWork: "Sans emploi, incapable de trouver du travail",
        unemployedCondition: "Sans emploi, en raison de l'état",
        retiredAge: "Retraité, ne travaillant pas en raison de l'âge",
      },
    },
    ...
    en: {
      ...
      msppData: {
        ...
        breastfeeding_WomenVitA: "Breastfeeding Women Receiving Vitamin A",
        breastfeeding_WomenMUAC: "Breastfeeding Women with MUAC<210mm",
        breastfeeding_WomenMalnutrition: "Breastfeeding Women with Malnutrition Support",
        ...
        mainConditionTetraplegia: "SCI - tetraplegia",
        mainConditionComplete: "Complete",
        mainConditionIncomplete: "Incomplete",
        mainConditionC1: "Level of Injury: C1",
        mainConditionC2: "Level of Injury: C2",
        mainConditionC3: "Level of Injury: C3",
        mainConditionC4: "Level of Injury: C4",
        mainConditionC5: "Level of Injury: C5",
        mainConditionC6: "Level of Injury: C6",
        mainConditionC7: "Level of Injury: C7",
        mainConditionC8: "Level of Injury: C8",
        mainConditionT1: "Level of Injury: T1",
        mainConditionParaplegia: "SCI - paraplegia",
        mainConditionComplete2: "Complete",
        mainConditionIncomplete2: "Incomplete",
        mainConditionT2: "Level of Injury: T2",
        mainConditionT3: "Level of Injury: T3",
        mainConditionT4: "Level of Injury: T4",
        mainConditionT5: "Level of Injury: T5",
        mainConditionT6: "Level of Injury: T6",
        mainConditionT7: "Level of Injury: T7",
        mainConditionT8: "Level of Injury: T8",
        mainConditionT9: "Level of Injury: T9",
        mainConditionT10: "Level of Injury: T10",
        mainConditionT11: "Level of Injury: T11",
        mainConditionT12: "Level of Injury: T12",
        mainConditionL1: "Level of Injury: L1",
        mainConditionL2: "Level of Injury: L2",
        mainConditionL3: "Level of Injury: L3",
        mainConditionL4: "Level of Injury: L4",
        mainConditionL5: "Level of Injury: L5",
        mainConditionS1: "Level of Injury: S1",
        mainConditionS2: "Level of Injury: S2",
        mainConditionS3: "Level of Injury: S3",
        mainConditionS4: "Level of Injury: S4",
        mainConditionS5: "Level of Injury: S5",
        ...
        SCIMale: "Male",
        SCIFemale: "Female",
        mainConditionCont: "Main Condition - Cont.",
        mainConditionStroke: "Stroke/ CVA",
        mainConditionFracturedHip: "Fractured hip",
        mainConditionFracturedLongBones: "Fractured long bones",
        mainConditionNeurodegenerativeDisease: "Neurodegenerative Disease",
        mainConditionHeadInjury: "Head injury",
        mainConditionWoundCare: "Wound Care",
        mainConditionOtherMedical: "Other medical",
        mainConditionOtherTrauma: "Other trauma",
        timeFromInjury: "Time from Injury until Admitted to Rehab",
        ...
        numberOfOutpatientsRehab: "Number of outpatients",
        returningOutpatients: "Returning outpatients",
        newOutpatient: "New outpatient initial evaluations",
        mainConditionOfNewPatients: "Main Condition of New Patients",
        ...
        newOther: "Other",
        ageOfNewpatients: "Age of New patients",
        newAge0_5: "Age 0-5",
        newAge6_11: "Age 6-11",
      ...
      patient: {
        ...
        removePatient: "Remove Patient X",
        ...
        other: "Other",
        stroke: "Stroke",
        numDaysInRehab: "No. Days in Rehab Unit from admission to discharge: ",
        dischargeReason: "Discharge Reason",
        allGoalsMet: "All goals met",
        goalsPartiallyMet: "Goals partially met, sufficient for discharge",
        goalsNotMet: "Goals not met, discharged for alternate reason",
        dischargeOutcomeASC: "Discharge Outcome (ADLs/Self-Care)",
        independent: "Independent",
        modIndependent: "Modified Independent",
        supervision: "Supervision",
        minAssistance: "Minimum Assistance",
        modAssistance: "Moderate Assistance",
        maxAssistance: "Maximum Assistance",
        dependent: "Dependent",
        dischargeOutcomeTM: "Discharge Outcome (Transfers and Mobility)",
        mobilityAid: "Mobility Aid/Assistive Device Given?",
        wheelchair: "Wheelchair",
        walker: "Walker",
        cane: "Cane",
        crutches: "Crutches",
        dischargeLocation: "Discharge Location",
        returnHomeAlone: "Return home, alone",
        returnHomeFamily: "Return home, with family/caregiver(s)",
        admittedToHospital: "Admitted to hospital",
        dischargeEmploymentStatus: "Discharge Employment Status",
        employed: "Employed",
        unemployedWork: "Unemployed, unable to find work",
        unemployedCondition: "Unemployed, due to condition",
        retiredAge: "Retired, not working due to age",
      },
    },
  },
})
