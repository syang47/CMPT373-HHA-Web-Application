            ...
            <div v-if="!successful">
                ...
                <div>
                    <div class="form-group">
                        ...
                        <Field name="diedAfter48h" type="text" class="form-control" id="diedAfter48h" v-on:keyup="checkDiedAfter48h()"/>
                    ...
                    <div v-if="diedAfter48hMor" class="form-group">
                        ...
                        <Field name="diedInNICUAfter48" type="text" class="form-control" />
                        <ErrorMessage name="diedInNICUAfter48" class="error-feedback" />
                    </div>
                    <div v-if="diedBefore48hMor" class="form-group">
                        <label for="diedInPaedAfter48">Died in Paed after 48h</label>
                        <Field name="diedInPaedAfter48" type="text" class="form-control" />
                ...
                <div>
                    <div class="form-group">
                        ...
                        <Field name="selfDischarged" type="text" class="form-control" id="selfDischarged" v-on:keyup="checkSelfDischarged()"/>
                ...
                <div>
                    <div class="form-group">
                        ...
                        <Field name="admissions" type="text" class="form-control" id="admissions" v-on:keyup="checkAdmissions()"/>
                    ...
                    <div>
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsExtremelyPreterm" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsVeryPreterm" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsModerateToLatePreterm" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsFullTerm" type="text" class="form-control"/>
                    ...
                    <div>
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsMale" type="text" class="form-control"/>
                            <ErrorMessage name="admissionsMale" class="error-feedback" />
                        </div>
                        <div v-if="admissionsMor" class="form-group">
                            <label for="admissionsFemale">Female</label>
                            <Field name="admissionsFemale" type="text" class="form-control"/>
                    ...
                    <div>
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsRespiratoryArrest" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsAlteredMentalStatus" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsCardiacCongenitalAnomaly" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsOtherCongenitalAnomaly" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsMalnutrition" type="text" class="form-control"/>
                            <ErrorMessage name="admissionsMalnutrition" class="error-feedback" />
                        </div>
                        <div v-if="admissionsMor" class="form-group">
                            <label for="admissionsMeningitis">Meningitis</label>
                            <Field name="admissionsMeningitis" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsCommunityAcquiredPneumonia" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsAspirationPneumonia" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsModeratePrematurity" type="text" class="form-control"/>
                        ...
                        <div v-if="admissionsMor" class="form-group">
                            ...
                            <Field name="admissionsSeverePrematurity" type="text" class="form-control"/>
                ...
                <div>
                    <div class="form-group">
                        ...
                        <Field name="numberOfOutpatients" type="text" class="form-control" id="numberOfOutpatients" v-on:keyup="checkNumberOfOutpatients()"/>
                    ...
                    <div>
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsExtremelyPreterm" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsVeryPreterm" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsModerateToLatePreterm" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsFullTerm" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsOlderThanNeonate" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsAge4WeeksTo5" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsAge6To11" type="text" class="form-control"/>
                            <ErrorMessage name="numberOfOutpatientsAge6To11" class="error-feedback" />
                        </div>
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            <label for="numberOfOutpatientsAge12To18">Age 12-18</label>
                            <Field name="numberOfOutpatientsAge12To18" type="text" class="form-control"/>
                    ...
                    <div>
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsRespiratoryArrest" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsTraumaticInjury" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsSepticShock" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsHypovolemicShock" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsSeizures" type="text" class="form-control"/>
                            <ErrorMessage name="numberOfOutpatientsSeizures" class="error-feedback" />
                        </div>
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            <label for="numberOfOutpatientsPoisoning">Poisoning</label>
                            <Field name="numberOfOutpatientsPoisoning" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsAlteredMentalStatus" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsGastroenteritis" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsHemorrhage" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsHypothermia" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsCardiacCongenitalAnomaly" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsOtherCongenitalAnomaly" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsMalnutrition" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsMeningitis" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsCommunityAcquiredPneumonia" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsAspirationPneumonia" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsModeratePrematurity" type="text" class="form-control"/>
                        ...
                        <div v-if="numberOfOutpatientsMor" class="form-group">
                            ...
                            <Field name="numberOfOutpatientsSeverePrematurity" type="text" class="form-control"/>
